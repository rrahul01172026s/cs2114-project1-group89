 ...
 * stamina, and 4 attacks Current health and stamina are the only values that
 * can change during a battle
 * 
 * @author rrahu
 * @version Sep 17, 2026
 */
public class Beast
{
     ...
     * 
     * @param amount
     *            damage to take; cannot be negative
     ...
     *
     * @param amount
     *            stamina to spend; cannot be negative
     * @throws IllegalArgumentException
     *             if amount is negative
    ...
    public void useStamina(int amount)
    {
        ...
        {
            throw new IllegalArgumentException(
                "Stamina amount cannot be negative");
        }
     ...
     *
     * @param amount
     *            stamina to add; cannot be negative
     * @throws IllegalArgumentException
     *             if amount is negative
     */
