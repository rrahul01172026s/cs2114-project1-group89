 ...
 * // -------------------------------------------------------------------------
/**
 *  Builds all the data in the game: the beasts, attacks, opponents, and starter
 *  beasts. All of the games numbers reside in this file, so to change the
 *  games difficulty only edits to this file need to be made
 * 
 *  @author rrahu
 *  @version Sep 21, 2026
 */
public class GameData
{
    ...
    public List<Opponent> createOpponents() {
        ...
        opponents.add(new Opponent("Rookie Riley", createBrawlet(),
        ...
        opponents.add(new Opponent("Captain Marlow", createFireChimp(),
        ...
        opponents.add(new Opponent("Champion Vex", createSproutling(),
    ...
    private Beast createFireChimp() {
        Attack[] attacks = {
            new Attack("Flame shot", 12, BeastType.FIRE, 5),
    ...
    private Beast createTidalot() {
        Attack[] attacks = {
            new Attack("Aquajet", 10, BeastType.WATER, 5),
    ...
    private Beast createSproutling() {
        Attack[] attacks = {
            new Attack("Stick Throw", 9, BeastType.GRASS, 5),
    ...
    private Beast createBrawlet() {
        Attack[] attacks = {
            new Attack("Heavy Punch", 15, BeastType.NORMAL, 9),
